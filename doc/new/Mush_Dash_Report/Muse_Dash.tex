...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.6\textwidth]{figure/musedashicon.jpg} 
    \caption{Muse Dash}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=1.0\textwidth]{figure/hardware_top.png} 
    \caption{顶层模块架构图}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.7\textwidth]{figure/FSM.png} 
    \caption{判定逻辑的状态转移图}
    \label{fig:FSM}
\end{figure}
